 ...
 */
let iPhoneMemory = 8000
let iPhoneStorage = 3000
let videoMemory = 150

let currentMemory = iPhoneMemory - iPhoneStorage
let videoStorage = currentMemory / videoMemory

let youHave = "You have \(videoStorage) minutes of video available!"
