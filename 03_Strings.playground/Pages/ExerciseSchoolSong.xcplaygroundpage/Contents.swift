...
let schoolName = "SAIL THE BLACK SHIP"
let refrain = "With the WIND at our backs \(schoolName) we sail FORWARD!"
let secondLine = "TO WIN!"


let song = "\(refrain)\n \(refrain)\n Yes, \(refrain) \(secondLine) \(secondLine) \(secondLine)"
